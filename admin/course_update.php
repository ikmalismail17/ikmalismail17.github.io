                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header" style="background-color: teal;">
                                        <h3 class="card-title" style="color: white;">Course Update</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        ...
                                        <table id="example2" class="table table-bordered table-hover">
                                            ...
                                            ?>
                                                <form action="action/update0.php" method="POST">
                                                    ...
                                                    <tr>
                                                        <th> Course Name</th>
                                                        <td><input type="text" name="name" value="<?php echo $row['course_name']; ?>" autocomplete="off" required> </td>

                                                    </tr>
                                                    <tr>
                                                        <th>Course Code</th>
                                                        <td><input type="text" name="code" value="<?php echo $row['course_code']; ?>" autocomplete="off" required></td>

                                                    </tr>
                                                    <tr>
                                                        <th>Course Period</th>
                                                        <td><input type="number" name="period" value="<?php echo $row['course_period']; ?>" autocomplete="off" min="1" max="10" required></td>
                                        ...
                                        <input type="submit" name="edit_course" onclick="return confirmUpdate()" style="background-color: green; color:white; float:right; width: 80px; " value="Update">
                                        </form>
