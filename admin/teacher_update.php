                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header" style="background-color: teal;">
                                        <h3 class="card-title" style="color: white;">Teacher Update</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        ...
                                        <table id="example2" class="table table-bordered table-hover">
                                            <?php
                                            $sql = "SELECT * FROM tbl_teacher WHERE teacherID ='$id'";
                                            ...
                                            ?>
                                                <form action="action/update0.php" method="POST">
                                                    ...
                                                    <tr>
                                                        <th>Name</th>
                                                        <td><input type="text" name="name" value="<?php echo $row['teacher_name']; ?>" autocomplete="off" required> </td>

                                                    </tr>
                                                    <tr>
                                                        <th>Username</th>
                                                        <td><input type="text" name="username" value="<?php echo $row['teacher_username']; ?>" autocomplete="off" required></td>

                                                    </tr>
                                                    <tr>
                                                        <th>E-mail</th>
                                                        <td><input type="email" name="email" value="<?php echo $row['teacher_email']; ?>" autocomplete="off" required></td>

                                                    </tr>
                                                    <tr>
                                                        <th>Contact</th>
                                                        <td><input type="tel" name="contact" value="<?php echo $row['teacher_contact']; ?>" autocomplete="off" required></td>
                                        ...
                                        <input type="submit" name="edit" onclick="return confirmUpdate()" style="background-color: green; color:white; float:right; width: 80px; " value="Update">
                                        </form>
