            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0">Course Register</h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                ...
                <div class="content">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-header" style="background-color: teal;">
                                        <h5 class="m-0" style="color: white;">Course Register</h5>
                                    </div>
                                    <div class="card-body">
                                        <form action="process_reg0.php" method="POST">
                                            <label for="course_name">Course Name</label>
                                            <input type="text" name="course_name" id="course_name" autocomplete="off" required><br>
                                            <label for="course_code">Course Code</label>
                                            <input type="text" name="course_code" id="course_code" autocomplete="off" required><br>
                                            <label for="course_period">Period</label>
                                            <select id="course_period" name="course_period" style="width: 100px; text-align:center;">
                                            ...
                                            <button type="submit" name="course_reg">Register</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-header" style="background-color: teal;">
                                    <h3 class="card-title" style="color: white;">Course Information List</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <script>
