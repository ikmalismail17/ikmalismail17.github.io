                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="action/delete0.php?delete_class=<?php echo $row['classID']; ?>" onclick="return confirmDelete()" role="button" style="background-color: red; color:white">Drop</a>
                                                                <a href="class_update.php?edit_class=<?php echo $row['classID']; ?>" role="button" style="background-color: green; color:white;">Edit</a>
                                                            </td>
                                                        </tr>
