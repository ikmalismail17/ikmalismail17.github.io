                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="action/delete0.php?delete_course=<?php echo $row['courseID']; ?>" role="button" onclick="return confirmDelete()" style="background-color: red; color:white">Drop</a>
                                                                <a href="course_update.php?edit_course=<?php echo $row['courseID']; ?>" role="button" style="background-color: green; color:white;">Edit</a>
                                                            </td>
                                                        </tr>
