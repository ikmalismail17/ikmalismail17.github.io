                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header" style="background-color: teal;">
                                        <h3 class="card-title" style="color: white;">Teacher Information List</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        <script>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="action/delete0.php?delete=<?php echo $row['teacherID']; ?>" onclick="return confirmDelete()" role="button" style="background-color: red; color:white">Delete</a>
                                                                <a href="teacher_update.php?edit=<?php echo $row['teacherID']; ?>" role="button" style="background-color: green; color:white;">Edit</a>
                                                            </td>
                                                        </tr>
                                        ...
                                        <button style="float: right; background-color:blue; color:white;" onclick="location.href='view_student.php'">Student</button>
                                    </div>
                                    <!-- /.card-body -->
                                </div>
                                <!-- /.card -->
