...
?>
    ...
    <head>
        ...
        <title>Class/Course Register</title>
    ...
    <body class="text-center hold-transition sidebar-mini">
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0">Course/Class Register</h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <form action="process.php" method="POST">
                                    ...
                                    <h6 style="background-color: black; color:white">Register 2 Only</h6>
                                    <?php
                                    if ($query) {
                                    ...
                                    <div class="card">
                                        <div class="card-header" style="background-color: green;">
                                            <h3 class=" card-title" style="color: white;">Course</h3>
                                        </div>
                                        <div class="card-body">
                                            <?php
                                            if ($query1) {
                                            ...
                                            ?>
                                                    ...
                                                    <label><?php echo $row1['course_name']; ?></label>
                                                    <input type="radio" name="courseID" value="<?php echo $row1['courseID']; ?>"><br>
                                    ...
                                    <div class="card">
                                        <div class="card-header" style="background-color: green;">
                                            <h3 class="card-title" style="color: white;">Class</h3>
                                        </div>
                                        <div class="card-body">
                                            <?php
                                            if ($query1) {
                                            ...
                                            ?>
                                                    <label>Class <?php echo $row2['class_name']; ?></label>
                                                    <input type="radio" name="classID" value="<?php echo $row2['classID']; ?>"><br>
                                    ...
                                    <button class="edit" type="submit" onclick="return confirmReg()" id="submit" name="reg">Register</button>
        ...
        <script>
            function confirmReg() {
                var x = confirm("Choose Carefully, You have 2 choice only");
                if (x == true) {
                    return true;
                } else {
                    return false;
