                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="card card-primary text-center">
                                            <div class="card-header" style="background-color: green;">
                                                <h4 class="text-center" style="color: white;">About Me</h4>
                                            </div>
                                            <!-- /.card-header -->
                                            <div class="card-body">

                                                <input type="hidden" name="id" value="<?php echo $row['studentID']; ?>" autocomplete="off">
                                                <strong>Name</strong>

                                                <p class="text-muted">
                                                    <input id="rcorners2" type="text" name="name" value="<?php echo $row['student_fullname']; ?>" autocomplete="off">
                                                </p>
                                                ...
                                                <p class="text-muted"> <input id="rcorners2" type="email" name="email" value="<?php echo $row['student_email']; ?>" autocomplete="off"></p>
                                                ...
                                                <p class="text-muted">
                                                    <input id="rcorners2" type="tel" name="contact" value="<?php echo $row['student_contact']; ?>" autocomplete="off">
                                                </p>

                                                <hr>

                                                <button class="edit" onclick="return confirmUpdate()" name="studpro_update" style="width: 80px;">Save</button>
