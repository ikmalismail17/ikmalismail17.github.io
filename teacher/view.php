                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header" style="background-color: blue;">
                                            <h3 class="card-title" style="color: white;" id="teacher">Teacher Information List</h3>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <button style="float: right; background-color:blue; color:white;" onclick="location.href='view_stud.php'">Student</button>
                                        </div>
                                        <!-- /.card-body -->
                                    </div>
                                    <!-- /.card -->
