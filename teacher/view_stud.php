                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header" style="background-color: blue;">
                                            <h3 class="card-title" style="color: white;" id="student">Student Information List</h3>
                                        ...
                                        <div class="card-body">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="update_stud.php?edit_stud=<?php echo $row['studentID']; ?>" role="button" style="background-color: green; color:white;">Edit</a>
                                                                </td>
                                                            </tr>
                                            ...
                                            <button style="float: right; background-color:blueviolet; color:white;" onclick="location.href='view.php'">Teacher</button>
                                        </div>
                                        <!-- /.card-body -->
                                    </div>
                                    <!-- /.card -->
