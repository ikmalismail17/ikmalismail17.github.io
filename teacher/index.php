                     ...
                     <div class="container-fluid">
                         <div class="row">
                             <div class="col-lg-4">
                                 <div class="card card-blue">
                                     ...
                                     <div class="card-body">
                                         ...
                                         <a href="view.php" class="btn btn-primary" style="background-color:blue">Teacher List</a>
                                     </div>
                                 </div>
                             </div>
                             <div class="col-lg-4">
                                 <div class="card card-blue">
                                     ...
                                     <div class="card-body">
                                         ...
                                         <a href="view_stud.php" class="btn btn-primary" style="background-color:blue">Student List</a>
                                     </div>
                                 </div><!-- /.card -->
                             </div>
                             <!-- /.col-md-6 -->
                             <div class="col-lg-4">
                                 <div class="card card-blue">
                                     <div class="card-header">
                                         <h5 class="m-0">Course/Class</h5>
                                     </div>
                                     <div class="card-body">
                                         <p class="card-text">
                                             Number of Student Register
                                         </p>
                                         <?php
                                            $sql2 = " SELECT COUNT(*) FROM tbl_register";
                                         ...
                                         <a href="teacher_class.php" class="btn btn-primary" style="background-color:blue;">Register List</a>
                                     </div>
                                 </div>
                             </div>
                             <div class="col-lg-12">
